...
def parse_arguments():
    ...
    parser.add_argument("--mode", default = "random_plus_avg_length", choices = ["group", "full_random", "semantic_sim", "concept_plus_semantic_sim", "avg_length", "seq_length", "maximum_diff", 'random_plus_avg_length'])
...
modes = ["group", "seperate", "full_random", "semantic_sim", "concept_plus_semantic_sim", "avg_length", "seq_length", "maximum_diff", 'random_plus_avg_length']
